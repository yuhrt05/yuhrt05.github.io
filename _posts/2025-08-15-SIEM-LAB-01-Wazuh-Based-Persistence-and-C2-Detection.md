...
-----|------------------------------------------|-----------------------------------|----------------------------------------
1    | Email Phishing (.zip chứa .xlsm)         | Tải file                          | File độc hại vào máy
2    | -                                        | Giải nén .zip                     | Có file .xlsm
3    | Macro Execution                          | Enable Macro                      | PowerShell chạy ngầm
4    | Payload Download (Invoke-WebRequest)     | -                                 | payload.ps1 vào %TEMP%
5    | Payload Execution                        | -                                 | Reverse shell + persistence
6    | Reverse Shell                            | -                                 | Attacker có shell
7    | File Discovery                           | -                                 | Tìm thấy Password.txt
8    | Data Exfiltration                        | -                                 | Gửi dữ liệu về Kali:8000
```
...
- Trên host: tìm PID kết nối tới 192.168.200.132:4444 → taskkill /PID pid /F.
